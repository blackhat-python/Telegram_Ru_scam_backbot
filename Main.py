...
ADMIN_ID = "admin_id"  # Replace with your Telegram ID
...
async def start(message: types.Message):
    await message.answer("Welcome! Please agree to continue. Remember Dont ask for contact , Due to privacy i wont provide my contack details no phone >
